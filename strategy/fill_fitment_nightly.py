...
NOTE_T1 = "Industry reference (T1 third-party fitment guide) — NOT DINWEYS official OEM confirmation. Verify against vehicle spec before replacement."
...
updates = {
    "FUSO-FIGHTER": {
        ...
        "compatibility_note": "Fuso Fighter spans light(FK/FM/FN, small 55D23R/80D26R) to heavy(FP/FS/FV, N150) classes. DINWEYS 145G51 only matches the heavy N150 variants. Light/medium Fighter groups have no DINWEYS match — 需询价.",
        "source": SOURCE,
    ...
    "FUSO-SUPER-GREAT": {
        ...
        "compatibility_note": "Super Great is the Fuso heavy-truck (FP/FS/FV) range; Club Assist lists these heavy Fuso series as N150 (2x12V series, 24V system). DINWEYS 145G51 matches. Verify tray width/terminal orientation.",
        "source": SOURCE,
        "source_date": SOURCE_DATE,
        "confidence": "LOW",
    ...
    "MB-ACTROS": {
        ...
        "compatibility_note": "Actros 24V = 2x12V series. Standard fitment N150 (MFN150A, DIN Euro-spec); heavy-duty option N200 (273mm wide); note BlueTec 6 MFN180A is a DIN 180Ah group DINWEYS does not stock. DINWEYS 145G51/190H52 are JIS-group matches by dimensions.",
        "source": SOURCE,
        "source_date": SOURCE_DATE,
        "confidence": "MEDIUM",
    ...
    "MB-ATEGO": {
        ...
        "compatibility_note": "Atego (distribution) 24V = 2x12V. Standard N150, heavy-duty option N200. DINWEYS 145G51/190H52 are JIS-group matches by dimensions to the MFN150A/MFN200A DIN groups.",
        "source": SOURCE,
        "source_date": SOURCE_DATE,
        "confidence": "MEDIUM",
    ...
    "DAF-XF": {
        ...
        "compatibility_note": "DAF XF 24V = 2x12V. XF95/XF105 standard = N150 (MFN150A DIN); XF105 FAD 8x4 rigid 2013-on = N200. DINWEYS 145G51/190H52 are JIS-group matches by dimensions to DIN groups.",
        "source": SOURCE,
        "source_date": SOURCE_DATE,
        "confidence": "MEDIUM",
    ...
    "IVECO-STRALIS": {
        ...
        "compatibility_note": "Stralis 24V = 2x12V. ATi/460 line = N150 (2002-13) -> N200 (2014-on E5). AD/AS-L/AT variants use smaller HCC27SC (95D31/D31) group — no DINWEYS match, 需询价.",
        "source": SOURCE,
        "source_date": SOURCE_DATE,
        "confidence": "MEDIUM",
    ...
    "UD-QUON": {
        ...
        "compatibility_note": "Quon is U.D. Trucks' heavy range (CW/GK/GW series); Club Assist lists these U.D. heavy models as N150. 24V = 2x12V. DINWEYS 145G51 matches. Verify tray before replacement.",
