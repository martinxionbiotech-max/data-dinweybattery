...
faq:
  ...
  - q: How many batteries does a semi truck have?
    a: A 24V semi truck has two 12V batteries in series for starting. Some also carry a separate auxiliary battery for trailer or sleeper-cab loads.
  - q: Why do semi trucks use 24V?
    a: 24V halves the current for the same power, allowing thinner wiring and more reliable cranking of the large diesel engine.
  - q: What CCA do semi trucks need?
    a: Heavy-duty semi trucks typically need 850–1100+ CCA, and more in cold climates. Confirm the exact requirement in the vehicle manual.
  - q: Should semi truck batteries be replaced in pairs?
    a: Yes. In a 24V series system, always replace both batteries as a matched pair of the same model, age and rating.
---

# Batteries for Semi-Trailers & Heavy Haulers
...
Semi trucks are the largest road-going commercial vehicles, and their electrical systems
reflect that:

| Component | Specification |
|---|---|
| System voltage | 24V (two 12V in series) |
| CCA requirement | 850–1100+ CCA |
| JIS market models | 190H52 (N200), 145G51 (N150) |
| DIN market models | 60038 (DIN100), 58827 (DIN88) |

## Why 24V?

A 24V system halves the current for the same power, which:

- Allows thinner, lighter wiring
...
2. **Match the CCA** — 850–1100+ depending on engine and climate
