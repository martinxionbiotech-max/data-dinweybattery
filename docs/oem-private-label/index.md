...
Private label (also called OEM or ODM) means buying batteries manufactured by a factory but
sold under your own brand. It is how most battery distributors build a regional brand:

| You provide | The manufacturer provides |
|---|---|
...
1. **Label and branding** — your name, logo, model numbering
2. **Specification** — CCA, capacity, terminal type
3. **Case and packaging** — color, box design
4. **Documentation** — your branding on datasheets and certificates

## The Private-Label Process

1. **Define** — target market, battery spec, branding
2. **Agree** — specification, labeling, MOQ, pricing, lead time
3. **Sample** — approve a pre-production sample
