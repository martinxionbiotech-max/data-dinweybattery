...
faq:
  - q: What do the numbers on a battery datasheet mean?
    a: They are the battery's specification — 12V or 24V, Ah (e.g. 135 Ah), CCA (e.g. 900 A), reserve capacity (e.g. 220 min), dimensions, terminal type and polarity. Reading all of them correctly prevents a wrong purchase.
  ...
  - q: What does Ah mean on a battery?
    a: Ah (amp-hours) is the battery's total energy capacity at a specified discharge rate — a 135 Ah N150 holds 135 Ah at the 20-hour rate. It is different from CCA, which measures cold-start power.
  ...
  - q: What is the most common datasheet mistake?
    a: Focusing only on CCA (e.g. 900 A) and ignoring dimensions and polarity. A high-CCA battery that does not fit the tray or has reversed polarity is unusable.
---
...
1. **CCA, Ah and RC answer 3 different questions** — "will it start cold?", "how much energy?", "how long if the alternator dies?"; treating them as interchangeable is the root of wrong purchases.
