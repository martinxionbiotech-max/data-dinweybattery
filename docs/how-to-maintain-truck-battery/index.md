...
**TL;DR** — Extend truck battery life by keeping terminals clean and tight, maintaining a full
...
Vibration damages plates and causes internal shorts. Check the hold-down bracket regularly and
ensure the battery is firmly secured.

## 4. Check Electrolyte (if applicable)

For batteries with removable caps, check the electrolyte level and top up with **distilled
water only** — never tap water. Maintenance-free batteries are sealed and need no topping up.
...
When disconnecting, remove the **negative terminal first** and reconnect it **last** — this
...
| Frequency | Action |
|---|---|
| Every service | Clean terminals, check voltage, visual inspection |
