...
|---|---|---|---|---|
| A | JIS standard large post | 14.7 mm | 13.0 mm | JIS N50–N200 |
...
| System | Type | Used in |
|---|---|---|
| B0 | Top frame clamp | JIS batteries |
...
Installing a battery with the wrong terminal orientation can:

- Stress or damage the battery cables
- Create a short-circuit risk if terminals contact metal
- Prevent the hold-down from securing the battery properly
